...
INSERT INTO `cart_store` VALUES (1,'arroz pinillar',2,3500);
...
INSERT INTO `inventory_products` VALUES (10,1,'Panela','Proveedor a',2000,3000,7,'bueno','2024-12-09'),(11,1,'arroz pinillar','Proveedor a',1000,3500,32,'buen arroz','2024-12-09'),(12,3,'aceite','Proveedor a',2500,3600,23,'bueno','2024-12-10'),(13,1,'pera','Proveedor a',2000,3000,48,'bueno','2024-12-10'),(14,3,'queso','Proveedor a',1500,2000,500,'bueno','2024-12-10'),(15,1,'manzana verde','Proveedor a',1800,2800,46,'fruta deliciosa','2024-12-10'),(16,1,'Colcafé','Proveedor a',100,200,100,'bueno','2024-12-10'),(17,1,'Pan','Proveedor a',300,600,200,'bueno','2024-12-10'),(18,4,' Azúcar Blanca 500g','Proveedor a',1900,2000,80,'bueno','2024-12-10');
...
INSERT INTO `sale_details` VALUES (1,1,'arroz pinillar',1,3500,'Nombre del cliente','Efectivo',3500),(2,1,'Panela',1,3000,'Nombre del cliente','Efectivo',3000),(3,2,'arroz pinillar',1,3500,'Nombre del cliente','Efectivo',3500);
...
INSERT INTO `sales` VALUES (1,6500,'2024-12-10'),(2,3500,'2024-12-10');
...
-- Dump completed on 2024-12-11 10:00:03
