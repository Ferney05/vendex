                    ...
                    <table>
                        ...
                        <?php
                            ...
                            if($resultDish -> num_rows > 0){
                                while($row = mysqli_fetch_array($resultDish)){
                                    ...
                                    echo "<tr>
                                            ...
                                            <td class='view-details'>
                                                <a href='add-ingredients-dish.php?id=$id'>Agregar</a>
                                                <a href='ingredients-details.php?id=$id'>Ver</a>
                                            </td>
                                            <td>
                                                ...
                                                <a href='get-data-recipe.php?id=$id'>
                                ...
                                echo "<tr>
                                        <td colspan='10'>No hay platos</td>
                                      </tr>";
                            }
                        ?>
                    </table>
