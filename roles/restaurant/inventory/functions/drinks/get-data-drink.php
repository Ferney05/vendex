                        ...
                        <div class="alls">
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="text" name="name-drink" class="input-form b-col-fcs-val" placeholder="Nombre de la bebida" value="<?php echo $row['drink_name'] ?>" required>
                                </div>
                            ...
                            <div class="content-labels-inputs">
                                ...
                                <div class="label-input">
                                    ...
                                    <input type="text" name="stock" class="input-form b-col-fcs-val" placeholder="Cantidad disponible" value="<?php echo $row['available_stock'] ?>" required>
                                </div>
                            </div>
                        </div>

                        <div class="button-submit">
                            <input type="submit" name="button-update-drink" class="btn-form bg-btn" value="Actualizar">
                        </div>
                    </form>
                </div>
            </div>
