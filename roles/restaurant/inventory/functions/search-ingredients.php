...
<head>
    ...
    <title>Buscar ingrediente en el inventario - Vendex</title>
            ...
            <div class="table-products">
                <div class="tlt-search-add">
                    ...
                    <div class="search-add">
                            ...
                            $(document).ready(function(){
                                ...
                                $('#search-ingredient').autocomplete({
                                    source: function(request, response) {
                                        $.ajax({
                                            url: "autocomplete-ingredients.php", // Archivo PHP que consulta los productos
                                            type: "POST",
                        ...
                        <a href="../ingredient-inventory.php" class="add bg-btn">
                            ...
                            <p>Ver todos los ingredientes</p>
                        </a>
                    </div>
                </div>
                ...
                <div class="content-table">
                    <table>
                        ...
                        <?php
                            ...
                            $getIngredient= "SELECT * FROM ingredients WHERE name_ingredient LIKE '%$searchTerm%'";
                            ...
                            if($resultIngredient -> num_rows > 0){
                                while($row = mysqli_fetch_array($resultIngredient)){
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>
                                                <a href='delete-ingredient.php?id=$id'>
                                                ...
                                                <a href='get-data-ingredients.php?id=$id'>
