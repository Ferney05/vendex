                        ...
                        <div class="alls">
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="number" name="order-number" class="input-form" placeholder="Número de orden" value="<?php echo $row['order_number'] ?>" required>
                                </div>
                                ...
                                <div class="label-input">
                                    ...
                                    <input type="text" name="saucer" class="input-form" id="saucer" placeholder="Platillo" value="<?php echo $row['saucer'] ?>" required>
                                </div>
                            ...
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="number" name="quantity" class="input-form" placeholder="Cantidad" value="<?php echo $row['quantity'] ?>" required>
                                </div>

                                <div class="label-input">
                                    <label for="personalization">Personalización</label>
                                    <input type="text" name="personalization" class="input-form" placeholder="Personalización" value="<?php echo $row['personalization'] ?>" required>
                                </div>
                            ...
                            <div class="content-labels-inputs">
                                ...
                                <div class="label-input">
                                    ...
                                    <input type="text" name="estimated-time" class="input-form" placeholder="Tiempo estimado" value="<?php echo $row['estimated_time'] ?>" required>
                                </div>

                                <div class="button-submit">
                                    <input type="submit" name="button-update-orders" class="btn-form" value="Actualizar">
                                </div>
                            </div>
                        </div>
                    </form>
