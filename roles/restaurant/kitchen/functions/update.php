...
<body>
    ...
    <?php
        ...
        if(isset($_POST['button-update-orders'])) {
            ...
            $updateData = "UPDATE pending_orders SET order_number = $order_number, customer = '$customer', saucer = '$saucer', quantity = $quantity, personalization = '$personalization', order_status = '$status', type_service = '$type_service', estimated_time = '$estimated_time' WHERE id = $id_order";
