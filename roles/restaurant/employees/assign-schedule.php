                        ...
                        <div class="alls">
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="text" name="name-employee" id="name-employee" class="input-form" placeholder="Nombre del empleado" required>
                                </div>
                            ...
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="time" name="entry-time" class="input-form" required>
                                </div>

                                <div class="label-input">
                                    <label for="start-break">Hora de inicio del descanso</label>
                                    <input type="time" name="start-break" class="input-form" required>
                                </div>   
                            </div>
                            ...
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="time" name="departure-time" class="input-form" placeholder="" required>
                                </div>  

                                <div class="label-input">
                                    <label for="end-rest">Hora de fin del descanso</label>
                                    <input type="time" name="end-rest" class="input-form" required>
                                </div>
                            </div>
                        </div>

                        <div class="button-submit">
                            <input type="submit" name="button-assign-schedule" class="btn-form" value="Asignar">
                        </div>
                    </form>
                </div>
            </div>
