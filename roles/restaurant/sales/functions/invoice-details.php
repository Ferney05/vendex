        ...
        <section class="sect-details" id="hidden-modal">
            <div class="view-details">
                <div class="tlt-button">
                    ...
                    <a href="../sales-made.php" class="btn-details bg-btn">
                ...
                <div class="content-table">
                    <div class="tlt-info">
                        <?php
                            echo "<h3>Pedidos vendidos en la venta N° " . $id_sale . "</h3>";
                        ?>
                    </div>
                    ...
                    <table>
                        ...
                        <?php
                            $queryDetails = "SELECT * FROM order_sales_details WHERE sale_id = $id_sale";
