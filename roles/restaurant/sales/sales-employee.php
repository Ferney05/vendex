        ...
        <section class="new-sale-products" id="hidden-modal">
            <div class="new-sale">
                <div class="tlt-button">
                    <h2 class="tlt-function">Ventas realizadas por empleado</h2>
                    
                    <a href="new-sales.php" class="btn-new-sale bg-btn">
                ...
                <div class="content-table">
                    <table>
                        ...
                        <?php
                            $querySales = "SELECT se.name_employee, os.id, os.total_amount, os.sale_date 
                                        FROM sales_employees AS se
                                        INNER JOIN order_sales AS os ON se.sale_id = os.id 
                                        ORDER BY os.id DESC";
