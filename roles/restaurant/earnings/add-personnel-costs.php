        ...
        <section class="add-personnel-form" id="hidden-modal">
            <div class="add-form">
                <div class="tlt-button">
                    <h2 class="tlt-function">Agregar costos del personal</h2>
                ...
                <div class="content-form">
                    <form action="functions/adding-personnel-costs.php" method="POST" class="form">
                        <div class="alls">
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    <label for="employee">Empleado</label>
                                    <input type="text" name="employee" class="input-form b-col-fcs-val" id="employee" placeholder="Nombre del empleado" required>
                                </div>
                                
                                <div class="label-input">
                                    <label for="hours">Horas</label>
                                    <input type="number" name="hours" class="input-form b-col-fcs-val" placeholder="Horas laboradas" required>
                                </div>
                            </div>
                            ...
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="text" name="employee-position" id="position" class="input-form b-col-fcs-val" placeholder="Cargo del empleado" required>
                                </div>
                                ...
                                <div class="label-input">
                                    ...
                                    <input type="number" name="hourly-pay" class="input-form b-col-fcs-val" placeholder="Pago por hora" required>
                                </div>
                        ...
                        <div class="button-submit">
                            <input type="submit" name="button-add-costs" class="btn-form bg-btn" value="Agregar">
                        </div>
                    </form>
                </div>
            </div>
