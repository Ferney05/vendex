                ...
                <div class="content-form">
                    <form action="functions/adding-personnel-costs.php" method="POST" class="form">
                        <div class="alls">
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="text" name="employee" class="input-form" id="employee" placeholder="Nombre del empleado" required>
                                </div>
                                
                                <div class="label-input">
                                    <label for="hours">Horas</label>
                                    <input type="number" name="hours" class="input-form" placeholder="Horas laboradas" required>
                                </div>
                            </div>
                            ...
                            <div class="content-labels-inputs">
                                <div class="label-input">
                                    ...
                                    <input type="text" name="employee-position" id="position" class="input-form" placeholder="Cargo del empleado" required>
                                </div>
                                ...
                                <div class="label-input">
                                    ...
                                    <input type="number" name="hourly-pay" class="input-form" placeholder="Pago por hora" required>
                                </div>
                        ...
                        <div class="button-submit">
                            <input type="submit" name="button-add-costs" class="btn-form" value="Agregar">
                        </div>
                    </form>
                </div>
            </div>
